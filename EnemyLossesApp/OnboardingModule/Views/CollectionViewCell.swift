...
class CollectionViewCell: UICollectionViewCell {
    ...
    var amountOfAircraftsLabel: UILabel!
    var amountOfHelicoptersLabel: UILabel!
    var amountOfTanksLabel: UILabel!
    var amountOfApcLabel: UILabel!
    var amountOfFieldArtilleryLabel: UILabel!
    var amountOfMrlLabel: UILabel!
    var amountOfMilitaryAutoLabel: UILabel!
    var amountOfFuelTanksLabel: UILabel!
    var amountOfDronesLabel: UILabel!
    var amountOfNavalShipsLabel: UILabel!
    var amountOfAntiAircraftWareFareLabel: UILabel!
    var amountOfSpecialEquipmentLabel: UILabel!
    var amountOfMobileSRBMSystemsLabel: UILabel!
    var amountOfVehiclesAndFuelTanksLabel: UILabel!
    var amountOfCruiseMissilesLabel: UILabel!
